...
class BackGroundSubtractor:
    ...
    def getForeground(self, frame):
        ...
        self.backGroundModel = frame * self.alpha + \
            self.backGroundModel * (1 - self.alpha)
...
cam = cv2.VideoCapture("test_videos/test1.mp4")
...
while(run):
    ...
    if ret is True:
        ...
        ret, mask = cv2.threshold(foreGround, 40, 255, cv2.THRESH_BINARY)
